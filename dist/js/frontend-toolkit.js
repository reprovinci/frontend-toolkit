(function(){'use strict';var message$1 = 'Ik ben een fixed nav';
...
Swiper.use([Resize, Observer$1]);function _extends$2() {
...
defineJQueryPlugin(Collapse);var message = 'Hier kan javascript komen.';
console.log(message);}());